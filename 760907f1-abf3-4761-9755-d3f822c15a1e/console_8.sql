...
--      close_condition, previous_close_date, previous_cumulative_price, trade_low_condition, expiration_date, open_condition, symbol, load_batch_id
select "PermissionId(441)", "State(361)", "BidCondition(2)", "RecordStatus(447)", "UpdateId(483)", "BidSize(1)", "Bid(0)", "BidTime(3)", "BidExchange(4)",
       "AskTime(8)", "AskCondition(7)", "LastUpdateDate(413)", "AskSize(6)", "Ask(5)", "AskExchange(9)",
       "QuoteDate(11)", "PreviousClose(113)", "OptionType(329)", "CreateDate(395)", "TradeSize(13)", "Trade(12)", "TradeExchange(17)", "TradeDate(16)",
       "Open(35)", "ExpirationType(753)", "CloseDate(65)", "CumulativeValue(51)", "TradeId(1128)", "TradeHigh(18)", "EntityType(398)",
       "CloseStatus(63)", "CumulativePrice(50)", "TradeTime(15)", "PreviousTradingDate(112)", "TradeLow(22)", "ClosingQuoteDate(60)",
       "TradeCount(26)", "PreviousTradeTime(1359)", "ResetDate(449)", "Close(61)", "PreviousQuoteDate(654)", "CumulativeVolume(52)", "ClosingBid(56)",
       "PreviousOpen(114)", "ClosingBidExchange(57)", "TradeCorrectionTime(1132)", "ClosingAsk(58)", "TradeCondition(14)", "PreviousTradeHigh(115)",
       "CloseCumulativeVolumeDate(69)", "StrikePrice(362)", "PreviousAsk(653)", "OpenExchange(39)", "PreviousTradeLow(116)", "CloseCumulativeVolumeStatus(68)",
       "TradeIdCancel(1141)", "NetChange(54)", "LifetimeHigh(156)", "CloseCumulativeValueStatus(71)", "Mic(1159)", "PreviousNetChange(119)", "TradeLowTime(24)",
       "LifetimeLow(158)", "CloseCumulativeVolume(67)", "PercentChange(55)", "TradeIdOriginal(1129)", "CloseCumulativeValue(70)", "TradeHighTime(20)", "TradeCorrectionDate(1131)",
