...
AS SELECT NULL::text AS id,
    ...
    NULL::text AS executingbroker,
        CASE
            WHEN co.order_class = 'F'::bpchar THEN co.payload ->> 'InitiatorEntityId'::text
...
AS SELECT NULL::text AS id,
    ...
    (co.payload ->> 'AutoRouteRuleId')::int4  AS autorouteruleid,
    co.payload ->> 'AutoRouteRuleName'::text  AS autorouterulename,
    (co.payload ->> 'IsAutoAccepted')::bpchar AS isautoaccepted,
    (co.payload ->> 'IsAutoRouted')::bpchar   AS isautorouted
