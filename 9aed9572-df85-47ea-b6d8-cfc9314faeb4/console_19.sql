SELECT id,
       ...
       dtclearbookdatetime::timestamptz,
...
where x.order_trade_date_id between 20250630 and public.get_dateid(public.get_business_date(20250630::text::date, 1))
  AND (x._db_create_time::timestamp >
       '2025-06-30 10:58:10.357'::timestamp at time zone 'US/Central' - interval '1 second' or
       x.orig_db_create_time::timestamp >
       '2025-06-30 10:58:10.357'::timestamp at time zone 'US/Central' - interval '1 second' or
       x.rep_db_create_time::timestamp >
       '2025-06-30 10:58:10.357'::timestamp at time zone 'US/Central' - interval '1 second')
