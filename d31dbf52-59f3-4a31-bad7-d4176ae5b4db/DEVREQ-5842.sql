...
select * from dash360.report_fintech_adh_parent_order_count_int(20250401, 20250421, 'O');
...
begin
    ...
    where true
      ...
      and case
              when l_is_today then "Status_Date_id" < l_date_id
              else "Status_Date_id" <= l_date_id end
    ...
    if l_is_today then
        ...
        where true
          and co.create_date_id = to_char(current_date, 'YYYYMMDD')::int4
