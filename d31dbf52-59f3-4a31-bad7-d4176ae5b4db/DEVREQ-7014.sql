...
select * from dash360.report_fintech_clear_street_client_booking(20251101, 20251111)
create function dash360.report_fintech_clear_street_client_booking(in_start_date_id integer, in_end_date_id integer)
    returns table
            (
                rec text
            )
