...
select * from dash360.report_fintech_venue_breakdown_by_symbol(20260722, 20260722, null, '{73494}', null)
create function dash360.report_fintech_venue_breakdown_by_symbol(in_start_date_id integer,
...
begin
    ...
    select array_to_string(array [
                               ...
                               to_char(sum(cl.order_qty), 'FM99990D0099'),-- Order Qty
                               to_char(sum(last_qty), 'FM99990D0099'),-- Last Qty
                               to_char(100.0 * sum(last_qty) / sum(cl.order_qty), '990.99%')
                               ], ',', '')
