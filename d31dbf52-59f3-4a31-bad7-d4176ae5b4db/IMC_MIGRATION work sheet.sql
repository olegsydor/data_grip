...
------------------------------------------------------
create table trash.so_imc_transf as
   select cl.order_id,
           cl.transaction_id,
           cl.create_time,
           cl.order_qty,
...
--
           case
               when cl.PAR_ORDER_ID is null and STR.CROSS_ORDER_ID is not null
...
--   and cl.order_id = 16280308769
    ...
    and get_dateid(str.parent_order_process_time::date) = cl.create_date_id)
             ...
             left join trash.matched_cross_trades_pg mct on mct.orig_exec_id = coalesce(es.exec_id, cl.ex_exec_id)
