alter function dash360.report_rps_s3 rename to report_rps_s3_bkp;
-- DROP FUNCTION dash360.report_rps_s3(int4, int4, _int4, bpchar, _varchar);

CREATE FUNCTION dash360.report_rps_s3(in_start_date_id integer, in_end_date_id integer,
