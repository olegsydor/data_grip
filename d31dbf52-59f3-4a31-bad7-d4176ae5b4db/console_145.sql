...
select *
from dash360.report_equity_tca_init_v2(in_date_begin := 20250701,
                                       in_date_end := 20250930,
                                       in_account_ids := '{50081}',
                                       in_custom_configuration_algo := false, in_sub_strategy := '{"SENSOR"}')
