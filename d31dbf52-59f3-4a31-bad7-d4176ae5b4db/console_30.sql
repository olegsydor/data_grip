...
-- OS: 20240111 https://dashfinancial.atlassian.net/browse/DS-7809 added case for GTC_ORDER_STATUS
...
select max(exec_time) into l_max_exec_time
from staging.tlnd_temp_execution tte;
...
--------------------------------------------------------------------------------
-- Added SO 20240111 fot GTC case
