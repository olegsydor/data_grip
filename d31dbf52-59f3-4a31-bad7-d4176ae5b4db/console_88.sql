select * from dash360.report_fintech_eod_alpaca_options_retail(in_start_date_id := 20240901, in_end_date_id := 20240909);
...
begin
    ...
    return query
        select array_to_string(ARRAY [
                                   ...
                                   to_char(tr.order_process_time, 'HH24:MI:SS.MS'), -- as Timestamp
            -- SYMBOL
                                   di.symbol || '-' || -- as "SYMBOL",
