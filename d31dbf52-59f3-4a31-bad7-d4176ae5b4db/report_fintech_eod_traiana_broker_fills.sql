...
select * from dash360.report_fintech_eod_traiana_broker_fills(20241101, 20241102,'{70621}'), 'DASH', 1)
...
-- DROP FUNCTION dash360.report_fintech_eod_traiana_broker_fills(int4, int4, _int4, _varchar, text);

create or replace function dash360.report_fintech_eod_traiana_broker_fills(in_start_date_id integer default public.get_dateid(current_date),
                                                                           in_end_date_id integer default public.get_dateid(current_date),
                                                                           in_account_ids integer[] default null::integer[],
                                                                           in_trading_firm_ids character varying[] default '{}'::character varying[],
                                                                           in_exec_broker text default null::text,
