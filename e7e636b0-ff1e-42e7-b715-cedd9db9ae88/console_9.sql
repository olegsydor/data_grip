...
-- 	  else coalesce(fm.t440, fm.t1, '')
                                                              ...
                                                              in_tag_number=>440,
                                                              in_start_date_id=>to_char(tr.order_process_time, 'YYYYMMDD')::int),
        ...
        from genesis2.trade_record as tr
                 ...
                 left join genesis2.clearing_account ca
                           on ca.account_id = tr.account_id and CA.IS_DELETED = 'N' and CA.MARKET_TYPE = 'O' and
                              CA.IS_DEFAULT = 'Y'
        where tr.date_id = :l_date_id --to_char(in_date,'YYYYMMDD')::int
