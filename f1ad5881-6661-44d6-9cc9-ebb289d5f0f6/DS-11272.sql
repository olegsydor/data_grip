alter table dwh.clearing_instruction add column if not exists clearing_submitted_away bpchar null default 'N';
...
*/
    ...
    select  ' '
          ...
          ||case when user_filter is not null then replace(user_filter,' and CLIENT_ORDER_ID',' and tr.CLIENT_ORDER_ID') else '' end
