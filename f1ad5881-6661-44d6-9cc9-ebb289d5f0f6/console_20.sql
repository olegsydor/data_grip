...
select * from dash360.report_obo_compliance_sg(20250621, 20251006);
CREATE OR REPLACE FUNCTION dash360.report_obo_compliance_sg(in_date_begin_id integer, in_date_end_id integer)
    RETURNS TABLE
            (
                ...
                "Is Affiliated"             character,
                "Solicitation Flag"         text, "Request Date" text, "Request Time" text
            )
    LANGUAGE plpgsql
AS $function$
