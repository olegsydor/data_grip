...
-------
CREATE OR REPLACE FUNCTION trash.so_gtc_update_daily2(p_start_date_id integer DEFAULT NULL::integer, p_end_date_id integer DEFAULT NULL::integer)
 RETURNS integer
 LANGUAGE plpgsql
 SET application_name TO 'ETL: GTC update process'
AS $function$
...
where order_id in  (283685675, 283685676,283685677);
