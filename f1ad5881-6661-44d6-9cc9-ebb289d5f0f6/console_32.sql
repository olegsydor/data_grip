        ...
        WITH src AS
                 (SELECT 'BLAZE7_TLEGS'::TEXT                                            AS table_name,
                  ...
                  FROM (SELECT tlegs.pg_order_id                                                                     AS pg_ord_id,
                        ...
                        FROM staging.edw_blaze7_tlegs_edw AS tlegs
...
select * from staging.so_sync_test('TORDER', 20260803);
select * from staging.so_sync_test('TORDERMISC', 20260803);
select * from staging.so_sync_test('TLEG', 20260803);
select * from staging.so_sync_test('TREPORT', 20260803);
select * from staging.so_sync_test('TPRICE', 20260803);

select * from staging.sync_test_calculated_metrics
