...
in_alloc_instr_id int8 default null)
    RETURNS TABLE
            (
                date_id                integer,
...
$function$
    ...
    -- OS 20250529 https://dashfinancial.atlassian.net/browse/DS-10052 Add alloc_instr_id as an input parameter
begin
...
if in_alloc_instr_id is null then
    return query
