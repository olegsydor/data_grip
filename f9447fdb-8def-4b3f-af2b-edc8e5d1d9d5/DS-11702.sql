...
AS
$function$
-- SO 20260624 https://dashfinancial.atlassian.net/browse/DS-11702 Add validation on PTM submit API to block changing Opt Capacity from Customer to Firm if trade record is a cross
declare
begin
    return query
...
$function$
;
select * from dash360.clearing_get_trade_by_client_order_id(20260623, '{Kate20260522-040}')
