-- the file with ORDER_STATES in allocation
-- LEFT IT because ми знаємо як воно буває коли потім виявляється що воно таки треба вернути
...
select ai.alloc_instr_id, trash.allocations_instruction_commission_rate(in_alloc_instr_id := ai.alloc_instr_id, in_date_id := 20260825)
from genesis2.allocation_instruction ai
where date_id = 20260825;

select * from dash360.allocations_instruction_commission_rate(in_alloc_instr_id := -135339, in_date_id := 20260825)
