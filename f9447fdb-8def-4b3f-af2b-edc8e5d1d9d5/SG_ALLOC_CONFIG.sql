...
CREATE TABLE genesis2.sg_allocation_configuration (
	sg_alloc_config_id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	...
	CONSTRAINT sg_allocation_configuration_pk PRIMARY KEY (sg_alloc_config_id)
);
