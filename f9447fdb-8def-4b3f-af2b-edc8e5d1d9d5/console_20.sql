2347378857
  ...
  select nextval('load_timing_seq') into l_load_id; 1165980
  l_step_id:=1;
  l_cnt_rows := 0;

  l_date_id = in_date_id;

 into l_load_batch_id; 1165980
...
where date_id = 20250717
and alloc_instr_id = -81125;
...
select * from genesis2.clearing_account
    where clearing_account_id = -269296
