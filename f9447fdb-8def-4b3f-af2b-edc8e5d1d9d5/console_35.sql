...
-- select * from dash360.risk_management_get_param_history_v2(in_param_code := 'EDAYNV', in_size := 1,
--                                                                         in_scope := 'G');
...
-- select * from dash360.risk_management_get_requests_v2('2026-01-01'::timestamp, '2026-01-11'::timestamp);
...
-- select * from dash360.risk_management_get_request_v2(10);
