...
$function$
;
select $$INSERT INTO GENESIS2_QA_20100601.TABLE_RETENTION (TABLE_NAME,RETENTION_PERIOD,CLEANUP_SCHEDULE,KEY_FIELD,IS_ACTIVE)
VALUES ('$$|| x || $$.INSTRUMENT',120,'DAY','LAST_TRADE_DATE','Y');$$
    from unnest('{GENESIS2_QA_SMS_CMPLX,GENESIS2_UAT_SEG4_SMS0,GENESIS2_UAT_SEG4_SMS1,GENESIS2_UAT_SEG6_SMS0,GENESIS2_UAT_SEG6_SMS1,GENESIS2_UAT_SEG8_SMS0,GENESIS2_UAT_SEG8_SMS1,GENESIS2_UAT_SEG8_SMS3,GENESIS2_UAT_SEG9_SMS0}'::text[]) as x