...
--                                                                 and tr.is_busted = 'N'
    ...
    where alin.date_id between in_start_date_id and in_end_date_id
      and ca.account_id = any (l_account_ids)
      and ai.is_deleted = 'Y'
      and ai.alloc_instr_id = any (l_alloc_instr_id_reported) -- this alloc_instr_id was reported before
;
...
CREATE OR REPLACE FUNCTION dash360.bofa_allocation_report_v2_safe(in_start_date_id integer, in_end_date_id integer,
