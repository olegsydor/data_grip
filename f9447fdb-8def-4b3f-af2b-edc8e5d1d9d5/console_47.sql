...
-- 1061,263033,263035,263036,263037,263038,263039,263021,263071,263072,263073,263074,263075,263076,263077,263117,261659,263019,262707,141,581,641,9028,9029,12948,12989,12990,255528,255529,255530,255531,256299,259978,263020,263066,263067,263068,263069,263070,263293,263292,257858,263024,263023,263685,263022,257078,257450,256422,263306,257077
...
select * from dash360.bofa_allocation_report_v3(in_start_date_id := 20260807, in_end_date_id := 20260807, in_exec_broker := '019');


select * from dash_reporting.bofa_allocation_report
where dataset = 21106287

select * from staging.bofa_allocation_report_history
         where dataset = 21106287
where db_create_time::date = '2026-08-07'